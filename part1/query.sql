...
((SELECT dog_id FROM Dogs WHERE name='John Lick'), '2025-06-10 00:00:00', 30, 'Shadowlands', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name='John Lick'), '2025-06-10 01:30:00', 30, 'BadLands', 'cancelled'),
